...
class AddVideoFeedHandler(BaseHandler):
    ...
    def post(self):
        ...
        requests.get('http://record_thread/new_camera_feed:7000?url='+new_url)
        requests.get('http://analyze_thread/new_camera_feed:6000?url='+new_url)
...
class DeleteVideoFeedHandler(BaseHandler):
    ...
    def post(self):
        ...
        requests.get('http://record_thread/delete_camera_feed:7000?url='+new_url)
        requests.get('http://analyze_thread/delete_camera_feed:6000?url='+new_url)
